...
<input type="text" class="form-control" id="name" placeholder="Name" name="name" value="{{ $profileData->name }}">
                                </div>
                                <div class="mb-3">
...
<input type="text" class="form-control" id="address" name="address" placeholder="Address" value="{{ $profileData->address }}">
                                </div>
...
<div class="form-check mb-3">
    ...
    <button type="submit" class="btn btn-primary me-2">Save Changes
    </button>
</form>
