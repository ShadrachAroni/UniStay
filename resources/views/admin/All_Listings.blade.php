	...
	<div class="main-wrapper">
		...
		<div class="page-wrapper">
			...
			<div class="page-content">
				...
				<div class="card">
					<div class="card-body">
						<h4 class="mb-3 mb-md-0">All Listings(Unfeatured)</h4>
						<table class="table table-striped">
							...
							<tbody>
								@foreach ($properties->where('featured', false) as $property)
								<tr>
									<td class="py-1">
										<!-- image -->
                ...
                <div class="card">
					<div class="card-body">
						<h4 class="mb-3 mb-md-0">All Listings(featured)</h4>
						<table class="table table-striped">
							<thead>
								<tr>
									<th>Photo</th>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
					...
					@endforeach
                    <a href="#">
                        {{ $property->featured ? 'Featured' : 'Unfeatured' }}
                    </a>
					</h5>
