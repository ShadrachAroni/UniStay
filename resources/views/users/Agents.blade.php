...
<div class="page-content">
      ...
      <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
          <div>
            <h4 class="mb-3 mb-md-0">View Agents</h4>
          </div>
        ...
        <table class="table table-striped">
            ...
            <tbody>
            @foreach ($users->where('status', 'verified')->where('role_id', 3) as $user)
                ...
                <div class="d-flex align-items-center flex-wrap text-nowrap">
                <button href="{{ route('users.create') }}" class="btn btn-sm btn-primary"  data-bs-toggle="modal" data-bs-target="#create">Add Agent</button>
            </div>
          </div>
        </div>
        </table>
