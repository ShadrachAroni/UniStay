...
{
    protected $fillable = [
        'agent_id', 'title', 'description','policies', 'country', 'county', 'city', 'street', 'area_name', 'latitude','longitude', 'price', 'property_type_id', 'availability_status','beds_start','beds_end','baths','posted_at','video','payment'
    ];
